...
testMultiobjective =
  TestList
    [ "domination predicate" ~: do
        ...
        assertEqual
          "good dominates worst"
          True
          (domination problems good1 worst)
        assertEqual
          "good23 doesn't dominate good1"
          False
          (domination problems good23 good1)
        assertEqual
          "good1 doesn't dominate good23"
          False
          (domination problems good1 good23)
        assertEqual
          "best dominates good23"
          True
          (domination problems best good23)
        assertEqual
          "worst doesn't dominate best"
          False
          (domination problems worst best),
      ...
      "two NSGA-II steps" ~: do
        ...
        let result =
              flip evalRand (pureMT 1) $
                loop
                  (Generations 1)
                  (stepNSGA2bt mp noCrossover noMutation)
                  gs
